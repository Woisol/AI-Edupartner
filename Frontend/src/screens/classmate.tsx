			...
			{originText ?
				<>
					<div className="w-[800px h-[600px size-[calc(100%-40px)] mx-auto absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-whit rounded-2xl shadow-2xl flex">
						...
						<div className="flex-1 shrink-0 max-w-[800px]">
							<ContentCard title="AI对话" content="这是一段课堂翻译。" action={[]}></ContentCard>
						</div>
					</div>
					<Button variant="contained" size="large" className="!fixed right-6 bottom-6" onClick={() => { setOriginText(""); setVoiceFile(null); }}>清空</Button>
				</> :
				<>
